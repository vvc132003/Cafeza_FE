...
@Component({
  selector: 'app-table-kaban',
  templateUrl: './table-kaban.component.html',
  styleUrls: ['./table-kaban.component.scss']
})
export class TableKabanComponent implements OnChanges, OnInit, OnDestroy {
